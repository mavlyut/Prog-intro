_Примечание от автора_: сей код **не предназначен для списывания**. Автор был молод, код не идеален. При этом не все решения, лежащие в репозитории, были принят (были приняты 1-4, 6-8, 11). 
